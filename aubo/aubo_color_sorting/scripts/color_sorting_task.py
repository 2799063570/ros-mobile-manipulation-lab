...
from aubo_color_sorting.msg import DetectedObjectArray
...
class ColorSortingTask(object):
    ...
    def __init__(self):
        ...
        self.table_center = rospy.get_param("~table_center", [0.70, 0.0, 0.0])
        self.table_size = rospy.get_param("~table_size", [0.70, 1.00, 0.20])
        ...
        self._publish_state("INITIALIZING", "waiting for fixed AUBO controllers")
        ...
        def worker():
            ...
            try:
                ...
                if self._stop_requested.is_set():
                    ...
                    self._publish_state("READY", "waiting for /sorting/start")
                else:
