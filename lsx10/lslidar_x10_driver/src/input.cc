...
#include "lslidar_x10_driver/input.h"
...
namespace lslidar_x10_driver
{
    ...
    int InputSocket::getPacket(lslidar_x10_msgs::LslidarX10PacketPtr &packet)
    {
    ...
    int InputPCAP::getPacket(lslidar_x10_msgs::LslidarX10PacketPtr &pkt)
    {
