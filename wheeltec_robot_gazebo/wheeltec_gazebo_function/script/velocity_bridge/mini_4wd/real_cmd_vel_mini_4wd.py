...
def calculate_mini_4wd_joint_velocity_steering(data):
    ...
    pub_vel_mini_4wd_left_front_wheel_joint = rospy.Publisher('/wheeltec/mini_4wd_left_front_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_right_front_wheel_joint = rospy.Publisher('/wheeltec/mini_4wd_right_front_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_left_rear_wheel_joint = rospy.Publisher('/wheeltec/mini_4wd_left_rear_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_right_rear_wheel_joint = rospy.Publisher('/wheeltec/mini_4wd_right_rear_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    a=data.velocity
    #rospy.loginfo(a)
...
def Pub_mini_4wd_real_cmd_vel():
    ...
    rospy.Subscriber("/wheeltec/joint_states", JointState, calculate_mini_4wd_joint_velocity_steering)
